...
describe("/jumplings", () => {
  ...
  describe("POST, happy and unhappy paths", () => {
  ...
  describe("GET, with jumplings in DB", () => {
    ...
    it("should return 404 to GET requests for jumplings that don't exist", async () => {
      await request(app).get("/jumplings/603ddcc33237ca2baa869cbd").expect(404);
    });
  });
